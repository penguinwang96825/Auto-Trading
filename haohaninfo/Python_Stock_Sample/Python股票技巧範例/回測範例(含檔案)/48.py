...
for date in DayList():
    ...
    ax.plot_date(mdates.date2num(OrderTime), OrderPrice, 'b.')
    ax.plot_date(mdates.date2num(CoverTime), CoverPrice, 'g.')

    #定義title
    plt.title('Stock '+sid+' Price MA Line')
    ...
    #顯示繪製圖表
    plt.savefig(date+'_'+sid+'_MA+RSI_Strategy.png')
    plt.clf()
